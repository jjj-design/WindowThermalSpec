...
class TestCalcAoh0pFunction(unittest.TestCase):
    ...
    def test_assert(self):
        f = open(TEST_DIRECTORY + 'Aoh0p.csv','r',encoding='utf8')
        reader = csv.reader(f)
        header = next(reader)
...
class TestCalcAsf0pFunction(unittest.TestCase):                
    ...
    # 正しい値が返ってくるかどうかのテスト    
    def test_assert(self):
        f = open(TEST_DIRECTORY + 'Asf0p.csv','r',encoding='utf8')
        reader = csv.reader(f)
        header = next(reader)
        for i, row in enumerate(reader):
            row_float = [float(d) for d in row]
...
class TestCalcAxpFunction(unittest.TestCase):
    ...
    # 正しい値が返ってくるかどうかのテスト    
    def test_assert(self):
        f = open(TEST_DIRECTORY + 'Axp.csv','r',encoding='utf8')
        reader = csv.reader(f)
        header = next(reader)
        for i, row in enumerate(reader):
            row_float = [float(d) for d in row]
...
class TestCalcAoh0mFunction(unittest.TestCase):
    ...
    # 正しい値が返ってくるかどうかのテスト    
    def test_assert(self):
        f = open(TEST_DIRECTORY + 'Aoh0m.csv','r',encoding='utf8')
        reader = csv.reader(f)
        header = next(reader)
        for i, row in enumerate(reader):
            row_float = [float(d) for d in row]
...
class TestCalcAsf0mFunction(unittest.TestCase):
    ...
    # 正しい値が返ってくるかどうかのテスト    
    def test_assert(self):
        f = open(TEST_DIRECTORY + 'Asf0m.csv','r',encoding='utf8')
        reader = csv.reader(f)
        header = next(reader)
        for i, row in enumerate(reader):
            row_float = [float(d) for d in row]
...
class TestCalcAxmFunction(unittest.TestCase):
    ...
    # 正しい値が返ってくるかどうかのテスト    
    def test_assert(self):
        f = open(TEST_DIRECTORY + 'Axm.csv','r',encoding='utf8')
        reader = csv.reader(f)
        header = next(reader)
        for i, row in enumerate(reader):
            row_float = [float(d) for d in row]
